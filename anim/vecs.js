...
function _rotate_axis(u,v,w, t) {
  var s = Math.sin(t);  var c = Math.cos(t);
  var u2 = u*u, v2 = v*v, w2 = w*w;
  return [u2+(1-u2)*c, u*v*(1-c)+w*s, u*w*(1-c)-v*s, 0,
...
vec3.prototype.times      = function(v) { return new vec3(this.x()*v.x(), this.y()*v.y(), this.z()*v.z()); };
...
function mat4_rotate_axis(u,v,w, t) { return new mat4(_rotate_axis(u,v,w, t)); }
...
mat4.prototype.rotateAxis = function(u,v,w, t) { return this.timesRM(mat4_rotate_axis(u,v,w, t)); };
