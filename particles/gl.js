...
// START WEBGL:
       ...
       for (var n = 0 ; n < c.length ; n++) {
          ...
          if (c[n].getAttribute("data-render") == "gl") {
             ...
             canvas.handle.prepObject = function(obj, fragShaderId) {

                // ADD THIS OBJECT TO THE LIST OF OBJECTS IN THIS CANVAS:

//                var obj = [];
//                this.ACTIVE_OBJECTS = new List(obj, this.ACTIVE_OBJECTS);
...
// DRAW ONE WEBGL CANVAS FOR THIS ANIMATION FRAME
   ...
   function drawScene(canvas) {
      ...
      for( var n = canvas.handle.ACTIVE_OBJECTS; n != NIL; n = n.tail )
        n.val.display();
//        drawObject(gl, n.val);
